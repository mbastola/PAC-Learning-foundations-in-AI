...
\newcommand{\handout}[5]{
   ...
   \framebox{
      \vbox{
    \hbox to 5.95in {{\bf CSE 513T Theory of Artificial Intelligence \&
    	Machine Learning}
     	 \hfill #2 }
       \vspace{4mm}
       \hbox to 5.95in { {\Large \hfill #5  \hfill} }
       \vspace{2mm}
       \hbox to 5.95in { {\it #3 \hfill #4} }
      }
   }
   \end{center}
   \vspace*{4mm}
   ...
   \framebox{
    ...
    \hbox to 5.95in {{\bf CSE 513T Theory of Artificial Intelligence \&
	 Machine Learning}
     	 \hfill #1 }
       \vspace{4mm}
       \hbox to 5.95in { {\Large \hfill #3  \hfill} }
       \vspace{2mm}
...
%% \syllabus{January 13, 2015}{Brendan Juba}
